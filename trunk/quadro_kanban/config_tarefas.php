...
<body>
    ...
    <header>
		<div id="nome_usuario" class="menu_acesso_rapido">
        	<a href="../home/home.php"> <?php echo ( $_SESSION['usu_nome'] ) ?> </a> / <?php echo '<a href="quadro_kanban.php?pro_id= ', $pro_id, '&tip_id=', $permissao, '&action=', $default_action, '">'; ?> Quadro Kanban </a> 
    	</div>
